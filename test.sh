...
function delete_crap() {
  ...
  $SUDO apt -y purge minecraft-pi python-minecraftpi wolfram-engine sonic-pi libreoffice scratch >/dev/null 2>&1
  $SUDO apt-get autoremove >/dev/null 2>&1
  $SUDO apt-get purge >/dev/null 2>&1
  echo "::: DONE!"
}
...
function edit_samba() { 
  ...
  $SUDO /etc/init.d/samba restart >/dev/null 2>&1
  echo "::: DONE!"
}
...
function install_minidlna() { 
  ...
  $SUDO apt install -y minidlna >/dev/null 2>&1
  echo "::: DONE!"
}
...
function edit_minidlna() {  
  ...
  $SUDO update-rc.d minidlna defaults >/dev/null 2>&1
  echo "::: DONE!"
}
...
function install_hostapd() {  
  ...
  $SUDO apt install -y hostapd >/dev/null 2>&1
  echo "::: DONE!"
}
...
function install_exfat() {	
	...
	$SUDO apt-get install -y ntfs-3g exfat-fuse exfat-utils >/dev/null 2>&1
  $SUDO apt-get install usbmount >/dev/null 2>&1
...
function install_droppy() {
  ...
  $SUDO apt-get install -y node npm >/dev/null 2>&1
